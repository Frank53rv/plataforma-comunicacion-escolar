...
module Api
  class Application < Rails::Application
    ...
    # Los cinco módulos funcionales y el componente transversal son carpetas
    ...
    # de la Tabla 15 y de la Figura 18. El framework toma cada carpeta de app/ como raíz de
