...
| CU-03 | Administrar año lectivo y cursos | Directivo | — | El directivo está autenticado. | El año lectivo y sus cursos quedan creados o modificados. Cada curso creado, sea cual sea la vía de alta, queda con su canal grupal de tutores abierto (RF-25). | RF-11, RF-12, RF-16 |
...
| CU-07 | Editar anuncio | Docente | Servicio de notificaciones | Existe un anuncio propio publicado. | Se realiza como eliminación lógica del anuncio (CU-08) seguida de una publicación nueva (CU-06), con destinatarios resueltos nuevamente; no dispone de operación propia. | RF-19, RF-21 |
| CU-08 | Eliminar anuncio | Docente | — | Existe un anuncio propio publicado. | El anuncio queda eliminado lógicamente, con autor y fecha: se retira del historial y de la bandeja de los cuatro roles y del contador de anuncios sin leer, y conserva su registro, sus filas de entrega y su detalle consultable. | RF-20 |
| CU-09 | Consultar anuncios e historial | Directivo, docente, tutor, alumno | — | El usuario está autenticado. | El usuario obtiene los anuncios que le corresponden, filtrados; los anuncios eliminados no integran el historial ni la bandeja. | RF-22, RF-39, RF-40, RF-45 |
