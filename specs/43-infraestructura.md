...
|---|---|---|---|
| Cliente web | React 19, construido con Vite 8 y servido por nginx | Interfaz de operación para los cuatro roles. Archivos estáticos, sin renderizado en el servidor | Contenedor propio. Se consume desde el navegador del usuario |
| Interfaz de programación | Ruby on Rails 8.1 en modo interfaz, con ActionCable en el mismo proceso | Persistencia, autenticación, control de acceso, reglas de negocio, motor de notificaciones y canal de tiempo real | Contenedor propio sobre el subsistema Linux del equipo de desarrollo |
