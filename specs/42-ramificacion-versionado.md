...
# Tabla 42 · Modelo de ramificación y criterio de versionado
...
| feature/RF-nn-descripcion | Una rama por requisito funcional, nombrada con su código de la Tabla 17 | Prueba del flujo principal, de cada flujo de excepción del caso de uso y de autorización por los cuatro roles |
...
| Versión mayor | Incompatibilidad en el contrato de la Tabla 27 | Decisión del autor, registrada en el histórico de revisiones |
