...
|---|---|---|
| 1 | Clonar el repositorio en la distribución del subsistema Linux | El árbol de carpetas coincide con la Figura 18. La versión construida ubica los módulos bajo api/app/ y no bajo api/, como dibuja la Figura 18: la verificación se realiza contra api/app/ mientras la divergencia D-03 de la Tabla 38 permanezca abierta. |
| 2 | Copiar el archivo de ejemplo de variables de entorno y completar los valores propios de la instalación | Ninguna variable de la Tabla 30 queda sin valor |
...
| 4 | Ejecutar migraciones y cargar el archivo de datos de prueba | El esquema corresponde al diccionario de la Tabla 14 y el volumen al declarado en RNF-09 |
